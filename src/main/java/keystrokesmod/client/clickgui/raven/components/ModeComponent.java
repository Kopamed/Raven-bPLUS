...
public class ModeComponent extends Component {
    ...
    public void draw() {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString(String.valueOf(this.mode.getMode()), (float) ((this.p.category.getX() + 4 + bruhWidth) * 2), (float) ((this.p.category.getY() + this.o + 4) * 2), this.c, true);
        GL11.glPopMatrix();
    }
