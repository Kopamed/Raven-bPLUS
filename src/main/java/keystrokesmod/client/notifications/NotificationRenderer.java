...
public class NotificationRenderer {
    ...
    public void onRender(Render2DEvent e) {
        if (GuiModule.notifications()) NotificationManager.render();
    }

    public static void moduleStateChanged(Module m) {
        if (!GuiModule.notifications() || mc.currentScreen != null || ConfigManager.applyingConfig || ClientConfig.applyingConfig) return;
