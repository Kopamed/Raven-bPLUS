...
public class FovLSD extends Module {
    ...
    public static DoubleSliderSetting fov;
    private boolean up = true;

    public FovLSD() {
        super("FovLSD", category.fun, 0);
        this.registerSetting(speed = new SliderSetting("Speed:", 0.1D, 0.01D, 16D, 0.01D));
        this.registerSetting(fov = new DoubleSliderSetting("Fov Min/Max", 25, 180, 0, 360, 1));
    }
