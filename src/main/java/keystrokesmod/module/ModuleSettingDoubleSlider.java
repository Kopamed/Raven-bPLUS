...
public class ModuleSettingDoubleSlider extends ModuleSettingsList {
    ...
    public ModuleSettingDoubleSlider(String settingName, double defaultValueMin, double defaultValueMax, double min, double max, double intervals) {
