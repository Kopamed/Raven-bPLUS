...
public class ButtonMinMaxSlider extends Component {
    ...
    public void update(int x, int y){
        ...
        double mousePressedAt = Math.min(this.module.category.getWidth() - boxMargin*2 /*we make it so that the mouse press HAS to be inside the box*/, Math.max(0, x - this.sliderStartX));
