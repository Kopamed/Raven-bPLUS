...
public class ClickGui extends GuiScreen {
   ...
   public ClickGui() {
      ...
      ButtonCategory configs = new ButtonCategory("Configs");
      configs.setY(topOffset);
      categoryList.add(configs);
   }
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      //version
      /*
      if(Raven.outdated && Raven.beta) {
         int margin = 2;
         int rows = 1;
         for (int i = Raven.helloYourComputerHasVirus.length-1; i >= 0; i--) {
            String up = Raven.helloYourComputerHasVirus[i];
      ...
      */
      ...
      if (me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.a) {
         if (!this.s.visible) {
            this.s.visible = true;
         }

         r = me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.animate.isToggled() ? me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.an.getValueInt(0, 200, 2) : 200;
         if (me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.b) {
            r = 200 - r;
            if (r == 0) {
               me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.b = false;
               me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.a = false;
      ...
      } else if (me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.b) {
         me.kopamed.raven.bplus.client.feature.module.modules.client.CommandLine.b = false;
      }
