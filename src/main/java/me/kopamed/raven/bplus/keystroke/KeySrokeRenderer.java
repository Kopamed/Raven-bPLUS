...
package me.kopamed.raven.bplus.keystroke;

import java.io.IOException;

import me.kopamed.raven.bplus.keystroke.ui.KeyStrokeConfigGui;
import me.kopamed.raven.bplus.keystroke.ui.component.KeyStrokeL;
...
public class KeySrokeRenderer {
   ...
   public KeySrokeRenderer() {
      //KeyStroke f = Raven.getKeyStroke();

      // initiating the movement keys
      this.movementKeys = new KeyStrokeL[4];
      //System.out.println(Raven.getKeyStroke() == null);
