...
package me.kopamed.raven.bplus.keystroke.ui;
...
import me.kopamed.raven.bplus.keystroke.setting.settings.ColourSetting;
import me.kopamed.raven.bplus.keystroke.setting.settings.SliderSetting;
import me.kopamed.raven.bplus.keystroke.setting.settings.TickSetting;
import me.kopamed.raven.bplus.keystroke.ui.component.Component;
import me.kopamed.raven.bplus.keystroke.ui.component.components.Colour;
import me.kopamed.raven.bplus.keystroke.ui.component.components.Slider;
import me.kopamed.raven.bplus.keystroke.ui.component.components.Tick;
import me.kopamed.raven.bplus.client.Raven;
import me.kopamed.raven.bplus.helper.utils.MouseManager;
import me.kopamed.raven.bplus.helper.manager.ClientConfig;
...
public class KeyStrokeConfigGui extends GuiScreen {
   ...
   private List<me.kopamed.raven.bplus.keystroke.ui.component.Component> settings = new ArrayList<>();
   private MoveType moveType;
   private int componentHeight;

   public static me.kopamed.raven.bplus.keystroke.ui.component.Component helpingComponent = null;
...
/*
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {/*
      ...
      for(me.kopamed.raven.bplus.keystroke.ui.component.Component component : settings){
      ...
      if(xOffset != 0 || yOffset != 0){
         this.lastGuiX = barX;
         this.lastGuiY = barY;
         for(me.kopamed.raven.bplus.keystroke.ui.component.Component component : this.settings){
      ...
      for(me.kopamed.raven.bplus.keystroke.ui.component.Component component : this.settings){ // drawing all the settings
         component.draw();
      }
   ...
   protected void mouseClicked(int mouseX, int mouseY, int button) {
      ...
      if (button == 0) {
         ...
         //KeyStroke st = Raven.getKeyStroke();
