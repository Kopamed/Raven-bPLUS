...
public class ButtonCategory {
   ...
   public void rf(FontRenderer renderer) {
      ...
      if (!this.modulesInCategory.isEmpty() && this.categoryOpened) {
         ...
         net.minecraft.client.gui.Gui.drawRect(this.x - 1, this.y, this.x + this.width + 1, this.y + this.bh + categoryHeight + 4, (new Color(0, 0, 0, (int)(me.kopamed.lunarkeystrokes.module.modules.client.Gui.backgroundOpacity.getInput()/100 * 255))).getRGB());
      }
