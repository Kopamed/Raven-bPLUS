...
public class RangeSliderComponent implements Component {
    ...
    public void draw() {
        ...
        net.minecraft.client.gui.Gui.drawRect(this.module.category.getX() + boxMargin,
        ...
        int middleThing = (int) Utils.Java.round(this.barWidth / 2, 0) + this.module.category.getX()
                + (int) this.blankWidth + boxMargin - 1;

        // drwing the main colourded bar
        net.minecraft.client.gui.Gui.drawRect(startToDrawFrom,
                this.module.category.getY() + this.moduleStartY + textSize, finishDrawingAt,
                this.module.category.getY() + this.moduleStartY + textSize + boxHeight,
                Utils.Client.astolfoColorsDraw(14, 10));
        net.minecraft.client.gui.Gui.drawRect(middleThing,
                this.module.category.getY() + this.moduleStartY + textSize - 1,
    ...
    public void update(int mousePosX, int mousePosY) {
        ...
        double mousePressedAt = Math.min(
                this.module.category.getWidth()
                        - boxMargin * 2 /* we make it so that the mouse press HAS to be inside the box */,
